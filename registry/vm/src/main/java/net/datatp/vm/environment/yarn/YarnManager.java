package net.datatp.vm.environment.yarn;
...
import net.datatp.vm.HadoopConfigurationUtil;
...
abstract public class YarnManager {
  ...
  public void startContainer(Container container, VMConfig appVMConfig) throws YarnException, IOException {
    ...
    String logDir =  appVMConfig.getLocalLogDir() ;
    List<String> commands = Collections.singletonList(
        sb.append(command).
        append(" 1> ").append(logDir + "/" + appVMConfig.getVmId() + "-stdout").
        append(" 2> ").append(logDir + "/" + appVMConfig.getVmId() + "-stderr").toString()
    );

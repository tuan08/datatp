...
public class DecisionTreeRegressionExample extends Example {
  @Override
  public void run(SparkSession spark) throws Exception {
    // $example on$
    // Load the data stored in LIBSVM format as a DataFrame.
    Dataset<Row> data = spark.read().format("libsvm").load("src/data/sample_libsvm_data.txt");
  ...
  public static void main(String[] args) throws Exception {
    SparkSession spark = 
        SparkSession.builder().master("local").appName("DecisionTreeRegressionExample").getOrCreate();

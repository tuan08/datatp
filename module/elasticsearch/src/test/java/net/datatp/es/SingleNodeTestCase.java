...
@Ignore
public class SingleNodeTestCase extends ESTestCase {
  ...
  @BeforeClass
  public static void setUpClass() throws Exception {  stopNode(); }

  @AfterClass
  public static void tearDownClass() throws IOException { stopNode(); }
   ...
   * <code>false</code>.
   */
  protected boolean resetNodeAfterTest() { return false; }


  /** The plugin classes that should be added to the node. */
  protected Collection<Class<? extends Plugin>> getPlugins() { return Collections.emptyList(); }
  ...
  protected Settings nodeSettings() { return Settings.EMPTY; }
  ...
  public Client client() { return NODE.client(); }

  public String nodeName() { return "node_s_0"; }

  protected Node node() { return NODE; }
  ...
  protected IndexService createIndex(String index) { return createIndex(index, Settings.EMPTY); }

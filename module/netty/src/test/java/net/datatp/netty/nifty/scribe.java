...
public class scribe {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public static class Log_call extends TAsyncMethodCall {
      ...
      public void write_args(TProtocol prot) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements TProcessor {
    ...
    protected Processor(I iface, Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  TBase>> processMap) {
      super(iface, getProcessMap(processMap));
    }

    private static <I extends Iface> Map<String, ProcessFunction<I, ? extends TBase>> getProcessMap(Map<String,  ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
  ...
  public static class Log_result implements org.apache.thrift.TBase<Log_result, Log_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static class Log_resultStandardScheme extends StandardScheme<Log_result> {
      ...
      public void write(TProtocol oprot, Log_result struct) throws TException {
        struct.validate();
    ...
    private static class Log_resultTupleScheme extends TupleScheme<Log_result> {
      @Override
      public void write(TProtocol prot, Log_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(TProtocol prot, Log_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = ResultCode.findByValue(iprot.readI32());

 ...
 */
package net.datatp.netty.nifty;
...
public class NiftyServerUnitTest {
  private static final Logger  log = LoggerFactory.getLogger(NiftyServerUnitTest.class);
  ...
  public void testMaxConnections2() throws InterruptedException, TException
  {
    ...
    // now need to make sure we didn't double-decrement the number of
    // connections, so try again

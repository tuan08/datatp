...
public class SpringAppLauncher {
  static public void launch(Class<?> app, String[] configSource, String[] args) throws Exception {
  ...
  static public void launch(String[] config, String ... args) throws Exception {
    SpringApplicationBuilder builder = new SpringApplicationBuilder();

...
public class URLFetcherMetricBak implements Serializable {
  ...
  public URLFetcherMetricBak() {}
  
  public URLFetcherMetricBak(String name) {
    this.name = name;
  }
  ...
  public void merge(URLFetcherMetricBak other) {
